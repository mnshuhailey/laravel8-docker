...
1. Clone this project:
   ...
   ```sh
   git clone https://github.com/mnshuhailey/laravel8-docker.git
   ```

2. Inside the folder `laravel8-docker` and Generate your own `.env` to docker compose with the next command:
